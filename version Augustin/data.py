...
encouragements = [
    ...
    "Chaque petit pas compte. Soyez fier de vos progrès !",
    "N'oubliez pas de prendre soin de vous. Vous le méritez !",
    "Les hauts et les bas font partie de la vie. Restez positif !",
    "Vous êtes plus fort que vous ne le pensez. Gardez espoir !",
    "Chaque jour est une nouvelle opportunité. Profitez-en !",
    "Votre bien-être est important. Continuez à y travailler !",
    "Rappelez-vous que vous n'êtes pas seul. N'hésitez pas à demander de l'aide si besoin.",
